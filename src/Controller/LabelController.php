...
class LabelController extends Controller
{
    ...
    {
        return $this->render('label/index.html.twig', ['labels' => $labelRepository->findAll()]);
    }
    ...
    {
        return $this->render('label/show.html.twig', ['label' => $label]);
    }
    ...
    public function edit(Request $request, Label $label): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('label_edit', ['id' => $label->getId()]);
        }
